...
<div class="normal-container">
    <div class="content">
        <h2>Our Services</h2>
        <p>
            Comprehensive architectural solutions tailored to your vision and
            needs.
        </p>
        <div class="services-grid">
            <div class="service-item">
                ...
                <p>
                    Creating homes that reflect your lifestyle and personality.
                </p>
            </div>
            <div class="service-item">
                <h3>Commercial Spaces</h3>
                <p>Functional and inspiring workspaces for your business.</p>
            </div>
            <div class="service-item">
                <h3>Interior Design</h3>
                <p>Complete interior solutions from concept to completion.</p>
            </div>
            <div class="service-item">
                <h3>Consultation</h3>
                <p>
                    Expert advice and guidance for your architectural projects.
                </p>
            </div>
        </div>
