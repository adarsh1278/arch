<div class="container-1">
    ...
    <div class="content-1">
        <div class="content-1-item">
            <img src="h2.png" alt="Image 1" class="content-1-image" />
            <div class="content-1-description">
                <span>Roop nagar villa</span>
                <button>Resedential</button>
            </div>
        </div>
        <div class="content-1-item">
            <img src="h22.png" alt="Image 2" class="content-1-image" />
            <div class="content-1-description">
                <span>Lawrence</span>
...
<style>
    ...
    .content-2-description {
        ...
        height: 100%;
        flex: 0 0 36.8vmax;
        /* donâ€™t grow, donâ€™t shrink, fixed 258px */
        width: 20vmax;
    }
