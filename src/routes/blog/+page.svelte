    ...
    <div class="content-2">
      ...
      <div class="content-2-description">
        <p>
          ...
          insights to behind-the-scenes stories — explore how we think, build,
          and imagine at Archideus
        </p>
...
<style>
  ...
  /* small polish for images to look crisp on retina */
  img {
    display: block;
    max-width: 100%;
    height: auto;
  ...
  @media (max-width: 480px) {
    ...
    /* Further reduce gap for sections 1, 2, 3 on very small screens */
